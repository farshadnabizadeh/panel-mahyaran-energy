    ...
    >
      ...
      <div className="w-full md:w-1/2 h-64 sm:h-72 md:h-screen relative">
        <img
          ...
          alt={t.image.alt}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-end justify-center md:justify-end md:pr-16 pb-12 sm:pb-16 text-right">
          <div className="text-white drop-shadow-lg max-w-md px-4">
